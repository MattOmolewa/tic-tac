        ...
        {!isPvP && (
          <>
            ...
            <Option
              ...
              content="Easy"
              onClick={() =>
                onChangeDifficulty && onChangeDifficulty(Difficulty.Easy)
              }
            />
            <Option
              ...
              content="Normal"
              onClick={() =>
                onChangeDifficulty && onChangeDifficulty(Difficulty.Normal)
              }
            />
            <Option
              ...
              content="Hard"
              onClick={() =>
                onChangeDifficulty && onChangeDifficulty(Difficulty.Hard)
              }
            />
          </>
        )}
